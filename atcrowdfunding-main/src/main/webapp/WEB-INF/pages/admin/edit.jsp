        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="${PATH}/admin/updateAdmin" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input  name="username" type="text" class="form-control" id="exampleInputPassword2" value="${admin.username}">
                        </div>
                        <div class="form-group">
